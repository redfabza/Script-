...
Tab3:NewButton("🟡 เพิ่มความลื่น", "บูสต์ FPS และความลื่น", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/redfabza/FPS-BOOST/refs/heads/main/FPS_BOOST.lua"))() end)
